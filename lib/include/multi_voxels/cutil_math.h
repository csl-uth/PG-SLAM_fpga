...
#ifdef INT_HP
inline floatH3 make_floatH3(floatH4 a) {
...
inline float3 operator*(float3 a, int3 b) {
        return make_float3(a.x *float(b.x), a.y * float(b.y), a.z * float(b.z));
}
inline float3 operator*(int3 b,float3 a) {
        return a*b;
}
inline void operator*=(float3 &a, float3 b) {
	a.x *= b.x;
...
inline floatH3 operator*(floatH3 a, floatH b) {
	return make_floatH3(a.x * b, a.y * b, a.z * b);
}
...
inline float3 operator/(float3 a, uint b) {
        return make_float3(a.x / b, a.y / b, a.z / b);
}
inline float3 operator/(float3 a, uint3 b) {
        return make_float3(a.x / b.x, a.y / b.y, a.z / b.z);
}
inline void operator/=(float3 &a, float b) {
	a.x /= b;
...
#ifdef INT_HP
inline floatH dot(floatH3 a, floatH3 b) {
	return a.x * b.x + a.y * b.y + a.z * b.z;
}
#endif
